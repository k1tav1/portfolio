...
import ProfessionalIslandsCore from "@/components/ProfessionalIslandsCore";
    ...
    <div className="min-h-screen bg-[#FCFDFD] text-[#0F172A] antialiased">
        ...
        <div className="mx-auto max-w-[1280px] px-6 h-[64px] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-mono text-[10px] text-[#64748B]">PROFESSIONAL • ISOMETRIC ISLANDS • 10% OVERLAP • FLIP CARDS</div>
            </div>
      ...
      <section className="mx-auto max-w-[1280px] px-6 pt-10 pb-16 grid lg:grid-cols-[1.05fr_1fr] gap-8 items-start">
        <div className="lg:sticky lg:top-24">
          <div className="inline-flex items-center gap-2 font-mono text-[11px] tracking-wide bg-white border border-[#E2E8F0] shadow-sm px-3 py-1.5 rounded-full">
            ...
            ISOMETRIC ISLANDS • 4 PROJECTS • FLIP TO EVIDENCE • 10% OVERLAP
          </div>
          ...
          <div className="mt-6 rounded-[14px] border border-[#E2E8F0] bg-white p-4 shadow-sm">
            <div className="font-mono text-[11px] tracking-widest text-[#94A3B8] mb-2">NEW SCROLL EFFECT: ISOMETRIC ISLANDS</div>
          ...
          <div className="mt-6 flex gap-2">
            <button onClick={() => scrollToId("kaya")} className="bg-[#0F172A] text-white px-5 h-11 rounded-full text-[13px] font-medium">Explore Islands ↓</button>
        ...
        <div className="lg:sticky lg:top-24">
          <ProfessionalIslandsCore activeModule={activeModule} />
      ...
      <section ref={projectsRef} className="mx-auto max-w-[1280px] px-6 py-12 border-t border-[#E2E8F0] scroll-mt-24">
        <div className="rounded-[20px] bg-[#0F172A] text-white p-7 flex flex-col lg:flex-row justify-between gap-6">
          <div>
            <div className="font-mono text-[11px] tracking-widest text-white/50">PROFESSIONAL • ISOMETRIC ISLANDS • 10% OVERLAP • FLIP</div>
            <h3 className="mt-2 text-[22px] font-bold tracking-tight">You picked: Islands + 10% overlap + Flip evidence</h3>
            <p className="mt-2 text-white/60 text-[13px] max-w-[50ch]">This is Option C (Isometric Islands) upgraded with your choices: Medium 10% overlap (CODE CLOUD AI behind islands at 10% opacity, visible but readable) and flip cards instead of scroll-to-section.</p>
          </div>
